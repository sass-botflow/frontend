...
export const en = {
  ...
  auth: {
    ...
    verifyEmailRequired: "Please verify your email address before signing in.",
    verifyEmail: {
      ...
      resendError: "Could not send verification email. Please try again.",
      verifiedTitle: "Email verified",
      verifiedSubtitle: "Your email is verified. You can now sign in.",
    },
    forgotPasswordPage: {
  ...
  hero: {
    badge: "The #1 AI inbox for WhatsApp, Instagram & TikTok",
    title: "Turn every DM into revenue.",
    titleHighlight: "On autopilot.",
    subtitle:
      "BotFlow unifies WhatsApp, Instagram, and TikTok in one AI-powered inbox. Train your bot in 5 minutes — no flow builders, no developers, no missed leads.",
    ctaPrimary: "Start free — 14-day trial",
    ctaSecondary: "Watch demo",
    trust1: "No credit card",
    trust2: "Live in 5 minutes",
    trust3: "Official WhatsApp API",
    floatNewMessage: "New WhatsApp lead",
    floatAiReplied: "AI booked appointment",
    floatBrainActive: "AI handling 94%",
    floatAccuracy: "Response in 2s",
  },
  logoWall: {
    label: "Trusted by ambitious teams in",
    industries: [
      "Dental",
      "E-commerce",
      "Restaurants",
  ...
  bentoFeatures: {
    ...
    title: "Everything competitors charge extra for. Included.",
    subtitle:
      "One platform for inbox, AI training, multi-channel routing, and team collaboration — without the enterprise price tag.",
    items: [
      {
        title: "Unified inbox",
        description: "WhatsApp, Instagram & TikTok in one thread view. Never switch apps again.",
        size: "large" as const,
      },
      {
        title: "5-minute AI setup",
        description: "Guided wizard trains your bot from your website, PDFs, and FAQs.",
        size: "small" as const,
      },
      {
        title: "Human handoff",
        description: "AI escalates complex chats to your team with full context.",
        size: "small" as const,
      },
      {
        title: "Multi-language AI",
        description: "Auto-detects Arabic, French, English, Spanish and more.",
        size: "medium" as const,
      },
      {
        title: "Official APIs only",
        description: "WhatsApp Business API, Instagram Graph, TikTok — no gray-area hacks.",
        size: "medium" as const,
      },
      {
        title: "Team & roles",
        description: "Invite your whole team with owner, admin, and member permissions.",
        size: "small" as const,
      },
    ],
  },
  competitorEdge: {
    label: "Why BotFlow wins",
    title: "Stop paying for 3 tools. Use one.",
    subtitle:
      "ManyChat, Respond.io, and Tidio each solve one piece. BotFlow replaces them all — with AI that actually knows your business.",
    botflow: "BotFlow",
    features: [
      { name: "WhatsApp + Instagram + TikTok", botflow: true, manychat: false, respond: true, tidio: false },
      { name: "AI trained on your business", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "5-minute setup wizard", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "Unified inbox", botflow: true, manychat: false, respond: true, tidio: true },
      { name: "Official WhatsApp API", botflow: true, manychat: true, respond: true, tidio: false },
      { name: "No flow builder required", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "Starting at $49/mo", botflow: true, manychat: false, respond: false, tidio: true },
    ],
    competitors: {
      manychat: "ManyChat",
      respond: "Respond.io",
  ...
  cta: {
    label: "Join 500+ businesses",
    title: "Your competitors reply in hours. You'll reply in seconds.",
    subtitle:
      "Start your 14-day free trial. Connect WhatsApp, Instagram, or TikTok and let AI handle the rest.",
...
export const fr: Dictionary = {
  ...
  auth: {
    ...
    verifyEmail: {
      ...
      subtitle:
        "Nous avons envoyé un lien de vérification. Cliquez dessus pour activer votre compte.",
      ...
      resendError: "Impossible d'envoyer l'e-mail de vérification.",
      verifiedTitle: "E-mail vérifié",
      verifiedSubtitle: "Votre e-mail est vérifié. Vous pouvez maintenant vous connecter.",
    },
    forgotPasswordPage: {
    ...
    resetPasswordPage: {
      ...
      successSubtitle: "Votre mot de passe a été mis à jour. Vous pouvez vous connecter.",
      error: "Impossible de réinitialiser le mot de passe.",
      invalidToken: "Ce lien est invalide ou expiré. Demandez un nouveau lien.",
    },
    logout: "Déconnexion",
  },
  hero: {
    badge: "La boîte de réception IA n°1 pour WhatsApp, Instagram & TikTok",
    title: "Transformez chaque DM en revenu.",
    titleHighlight: "En autopilote.",
    subtitle:
      "BotFlow unifie WhatsApp, Instagram et TikTok dans une seule boîte de réception IA. Formez votre bot en 5 minutes — sans flow builder, sans développeur, sans leads manqués.",
    ctaPrimary: "Essai gratuit — 14 jours",
    ctaSecondary: "Voir la démo",
    trust1: "Sans carte bancaire",
    trust2: "En ligne en 5 minutes",
    trust3: "API WhatsApp officielle",
    floatNewMessage: "Nouveau lead WhatsApp",
    floatAiReplied: "IA a pris rendez-vous",
    floatBrainActive: "IA gère 94%",
    floatAccuracy: "Réponse en 2s",
  },
  logoWall: {
    label: "Approuvé par des équipes ambitieuses dans",
    industries: [
      "Dentaire",
      "E-commerce",
      "Restaurants",
  ...
  bentoFeatures: {
    label: "Conçu différemment",
    title: "Tout ce que les concurrents facturent en plus. Inclus.",
    subtitle:
      "Une plateforme pour la boîte de réception, la formation IA, le routage multi-canal et la collaboration — sans le prix entreprise.",
    items: [
      {
        title: "Boîte de réception unifiée",
        description: "WhatsApp, Instagram & TikTok dans une seule vue. Plus besoin de changer d'app.",
        size: "large" as const,
      },
      {
        title: "Configuration IA en 5 min",
        description: "Un assistant guidé forme votre bot depuis votre site, PDFs et FAQ.",
        size: "small" as const,
      },
      {
        title: "Transfert humain",
        description: "L'IA escalade les conversations complexes à votre équipe avec tout le contexte.",
        size: "small" as const,
      },
      {
        title: "IA multilingue",
        description: "Détecte automatiquement l'arabe, le français, l'anglais, l'espagnol et plus.",
        size: "medium" as const,
      },
      {
        title: "APIs officielles uniquement",
        description: "API WhatsApp Business, Instagram Graph, TikTok — sans hacks.",
        size: "medium" as const,
      },
      {
        title: "Équipe & rôles",
        description: "Invitez toute votre équipe avec permissions propriétaire, admin et membre.",
        size: "small" as const,
      },
    ],
  },
  competitorEdge: {
    label: "Pourquoi BotFlow gagne",
    title: "Arrêtez de payer 3 outils. Utilisez un seul.",
    subtitle:
      "ManyChat, Respond.io et Tidio résolvent chacun une partie. BotFlow les remplace tous — avec une IA qui connaît vraiment votre activité.",
    botflow: "BotFlow",
    features: [
      { name: "WhatsApp + Instagram + TikTok", botflow: true, manychat: false, respond: true, tidio: false },
      { name: "IA formée sur votre activité", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "Assistant de configuration 5 min", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "Boîte de réception unifiée", botflow: true, manychat: false, respond: true, tidio: true },
      { name: "API WhatsApp officielle", botflow: true, manychat: true, respond: true, tidio: false },
      { name: "Sans flow builder", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "À partir de 49 $/mois", botflow: true, manychat: false, respond: false, tidio: true },
    ],
    competitors: {
      manychat: "ManyChat",
      respond: "Respond.io",
  ...
  cta: {
    label: "Rejoignez plus de 500 entreprises",
    title: "Vos concurrents répondent en heures. Vous répondrez en secondes.",
    subtitle:
      "Commencez votre essai gratuit de 14 jours. Connectez WhatsApp, Instagram ou TikTok et laissez l'IA faire le reste.",
    button: "Essai gratuit",
    trust1: "Sans carte bancaire",
    trust2: "99,9% de disponibilité",
    trust3: "Annulation à tout moment",
  },
  pricing: {
...
export const ar: Dictionary = {
  ...
  auth: {
    ...
    verifyEmailRequired: "يرجى تأكيد بريدك الإلكتروني قبل تسجيل الدخول.",
    verifyEmail: {
      title: "تأكيد البريد الإلكتروني",
      subtitle: "أرسلنا رابط تأكيد إلى بريدك. انقر عليه لتفعيل حسابك.",
      resendButton: "إعادة إرسال بريد التأكيد",
      resending: "جارٍ الإرسال...",
      resendSuccess: "تم إرسال بريد التأكيد. تحقق من صندوق الوارد.",
      resendError: "تعذّر إرسال بريد التأكيد.",
      verifiedTitle: "تم تأكيد البريد",
      verifiedSubtitle: "تم تأكيد بريدك. يمكنك الآن تسجيل الدخول.",
    },
    forgotPasswordPage: {
      ...
      success: "إذا وُجد حساب لهذا البريد، فقد أُرسل رابط إعادة التعيين.",
      error: "تعذّر إرسال بريد إعادة التعيين.",
    },
    resetPasswordPage: {
      ...
      successSubtitle: "تم تحديث كلمة المرور. يمكنك الآن تسجيل الدخول.",
      error: "تعذّر إعادة تعيين كلمة المرور.",
      invalidToken: "رابط إعادة التعيين غير صالح أو منتهي. اطلب رابطاً جديداً.",
    },
    logout: "تسجيل الخروج",
  },
  hero: {
    badge: "صندوق الوارد الذكي رقم 1 لواتساب وإنستغرام وتيك توك",
    title: "حوِّل كل رسالة إلى إيراد.",
    titleHighlight: "تلقائياً.",
    subtitle:
      "BotFlow يوحّد واتساب وإنستغرام وتيك توك في صندوق وارد ذكي واحد. درّب بوتك في 5 دقائق — بدون flow builder، بدون مطورين، بدون عملاء ضائعين.",
    ctaPrimary: "ابدأ مجاناً — تجربة لمدة 14 يوماً",
    ctaSecondary: "شاهد العرض التوضيحي",
    trust1: "بدون بطاقة بنكية",
    trust2: "جاهز في 5 دقائق",
    trust3: "واجهة برمجة واتساب الرسمية",
    floatNewMessage: "عميل محتمل جديد على واتساب",
    floatAiReplied: "الذكاء الاصطناعي حجز موعداً",
    floatBrainActive: "الذكاء الاصطناعي يدير 94%",
    floatAccuracy: "رد خلال ثانيتين",
  },
  logoWall: {
    label: "موثوق به من فرق طموحة في",
    industries: [
      "طب الأسنان",
      "التجارة الإلكترونية",
      "المطاعم",
  ...
  bentoFeatures: {
    label: "مصمَّم بشكل مختلف",
    title: "كل ما يفرض المنافسون رسوماً إضافية عليه. مشمول.",
    subtitle:
      "منصة واحدة للصندوق الوارد وتدريب الذكاء الاصطناعي والتوجيه متعدد القنوات والتعاون — بدون سعر المؤسسات.",
    items: [
      {
        title: "صندوق وارد موحَّد",
        description: "واتساب وإنستغرام وتيك توك في عرض واحد. لا حاجة للتنقل بين التطبيقات.",
        size: "large" as const,
      },
      {
        title: "إعداد الذكاء الاصطناعي في 5 دقائق",
        description: "معالج موجَّه يدرّب بوتك من موقعك وملفات PDF والأسئلة الشائعة.",
        size: "small" as const,
      },
      {
        title: "تحويل بشري",
        description: "يصعِّد الذكاء الاصطناعي المحادثات المعقدة لفريقك مع السياق الكامل.",
        size: "small" as const,
      },
      {
        title: "ذكاء اصطناعي متعدد اللغات",
        description: "يكتشف تلقائياً العربية والفرنسية والإنجليزية والإسبانية والمزيد.",
        size: "medium" as const,
      },
      {
        title: "واجهات برمجة رسمية فقط",
        description: "واجهة برمجة واتساب للأعمال وInstagram Graph وتيك توك — بدون حلول غير رسمية.",
        size: "medium" as const,
      },
      {
        title: "الفريق والأدوار",
        description: "ادعُ فريقك بالكامل بصلاحيات المالك والمسؤول والعضو.",
        size: "small" as const,
      },
    ],
  },
  competitorEdge: {
    label: "لماذا يتفوّق BotFlow",
    title: "توقَّف عن دفع ثمن 3 أدوات. استخدم واحدة.",
    subtitle:
      "ManyChat وRespond.io وTidio يحلّ كل منها جزءاً واحداً. BotFlow يستبدلهم جميعاً — بذكاء اصطناعي يعرف نشاطك فعلاً.",
    botflow: "BotFlow",
    features: [
      { name: "واتساب + إنستغرام + تيك توك", botflow: true, manychat: false, respond: true, tidio: false },
      { name: "ذكاء اصطناعي مدرَّب على نشاطك", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "معالج إعداد في 5 دقائق", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "صندوق وارد موحَّد", botflow: true, manychat: false, respond: true, tidio: true },
      { name: "واجهة برمجة واتساب الرسمية", botflow: true, manychat: true, respond: true, tidio: false },
      { name: "بدون flow builder", botflow: true, manychat: false, respond: false, tidio: false },
      { name: "يبدأ من 49 دولار/شهر", botflow: true, manychat: false, respond: false, tidio: true },
    ],
    competitors: {
      manychat: "ManyChat",
      respond: "Respond.io",
  ...
  cta: {
    label: "انضم إلى أكثر من 500 شركة",
    title: "منافسوك يردّون خلال ساعات. أنت سترُد خلال ثوانٍ.",
    subtitle:
      "ابدأ تجربتك المجانية لمدة 14 يوماً. اربط واتساب أو إنستغرام أو تيك توك واترك الذكاء الاصطناعي يتولى الباقي.",
